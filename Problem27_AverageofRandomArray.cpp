...
float CalculateAverageofRandomNumbers(unsigned short arry[100], unsigned short Number)
{
    return (float)CalculateSumNumbers(arry, Number) / Number;
}

void PrintFunction(unsigned short arry[100], unsigned short Number)
{
    PrintArryRandomElement(arry, Number);
    cout << "\n Avirage of numbers is : " << CalculateAverageofRandomNumbers(arry, Number) << endl;
}
